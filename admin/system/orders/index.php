      ...
      <?php while($row = $result->fetch_assoc()): ?>
           <tr>
              ...
              <td><?php if($row['payment_method']){
                echo "Online Payment(Payment Done!)";
              } else{
                echo "Payment On Delivery(Payment Pending!)";
              }              
              ?></td>
              <td><?php echo $row['user_id']; ?></td>
              <td><a href="./order_products.php?id=<?php echo  $row['order_id'];?>" class="btn btn-success btn-sm">Order Products</a></td>
            </tr>
      <?php endwhile; ?>
   <?php endif; ?>
          </tbody>
