    ...
    <div class="container-fluid">
      ...
      <a href="../">
            ...
            <form  action="./proccess.php" method="post"  enctype="multipart/form-data" > 
                <input type="number" name="product_id"  value= "<?php echo $row['product_id']; ?>" hidden >
                <div class="form-group">
                      <label for="exampleInputEmail1">Product Name</label>
                      <input  name="name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" required value= "<?php echo $row['name']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Price</label>
                      <input name="price" type="number" class="form-control" id="exampleInputPassword1" value= "<?php echo $row['price']; ?>" required>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">Author</label>
                      <input name="author" type="text" class="form-control" id="exampleInputPassword1" value= "<?php echo $row['author']; ?>" required>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">Description</label>
                      <input name="description" type="text" class="form-control" id="exampleInputPassword1" value= "<?php echo $row['description']; ?>" >
                    </div>

                    <div class="form-group">
                      <label for="exampleInputPassword1">Upload Image</label>
                      <input name="file" type="file" accept="image/*" class="form-control" id="exampleInputPassword1" >
                    </div>
                    ...
                    <div class="form-group">  
                      ...
                      <select name="category_id" id="">
                        <?php if($result-> num_rows > 0): ?>
                          ...
                          <option value="<?php echo $row1['category_name'];?>" <?php if($row['category_id'] == $row1['category_name'])
                                            echo "selected"; ?>>
                    ...
                    <button type="submit" name="product" class="btn btn-success">Update Product</button>
              </form>
            </div>
