  ...
  <body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="dropdown-item" href="./user/shop?category=all">All Products</a>
                        <?php
                        ...
                        <?php if($result-> num_rows > 0): ?>
                          <?php while($row = $result->fetch_assoc()): ?>
                            <a class="dropdown-item" href="./user/shop?category=<?php
                    ...
                    <a class="nav-link" href="./user/cart">Cart 
            ...
            <div class="text-center search-box">
                <form action="./user/shop/search-product.php" method="post">
                    <input type="text" name="name" class="form-control search-box" placeholder="Search Product" required>
            ...
            <!-- slider  -->
            <div id="carouselExampleIndicators" class="carousel slide slider" data-ride="carousel" data-interval="4000">
            ...
            <div class="row content-1">
                    <div class="col-md-4 offset-md-2">
                                <img width="100%" src="./images/content.jpg" alt="">
                    </div>
                    <div class="col-md-4" style="padding-top: 20px;">
                                <div class="about">
                                    <p >
                                        <h4> About Us</h4>
                                        Scotbooks is a small, locally owned specialty bookshop located in the heart of Glasgow. We are proud of our Scottish heritage and conentrate on our core genres of Scottish Culture and Music.

                                        Wherever possible, Scotbooks sources its books from local publishers such as Cannongate, Lomax Press, and Waverly Books. We are commited to helping Scottish publishing thrive by ensuring we stock books at competitive prices.

                                        Scotbooks stocks books from some of Scotlands newest authors, we help new authors get in contact with local publishers and management companies to get thier foot on the publishing ladder.
                                    </p>
                                </div>
                    </div>
            </div>
            <br>
            <img class="fixed-image" width="99%" src="./images/shop.jpg" alt="" >
            <div class=" text-center">
               
                <div class="shop-from-us">
                        WE ARE OPEN <br>
                        SHOP FROM US <br>
                        <a href="./user/shop?category=all"><span class="badge badge-pill badge-warning" style="cursor:pointer;">SHOP NOW</span></a>
