  ...
  <div class="container-fluid">
        ...
        <!-- end of nav  -->
            ...
            <div class="text-center content-logo">
                        <img width="25%" src="./images/logo.jpg" alt="">
            </div>
            ...
            <div class="row">
                        ...
                        <h3>About Us</h3>
                            ...
                            Scotbooks is a small, locally owned specialty bookshop located in the heart of Glasgow. We are proud of our Scottish heritage 
                            and conentrate on our core genres of Scottish Culture and Music. Wherever possible, Scotbooks sources its books from local publishers
                            such as Cannongate, Lomax Press, and Waverly Books. We are commited to helping Scottish publishing thrive by ensuring we stock books 
                            at competitive prices. Scotbooks stocks books from some of Scotlands newest authors,
                            we help new authors get in contact with local publishers and management companies to get thier foot on the publishing ladder.
                    ...
                    ?> 
                                ...
                                <b>Address:</b><br><?php echo $row['phone']; ?><br>
                                <b>Phone:</b><br><?php echo $row['address']; ?><br>
                            </p>
                        </div>
            </div>
